...
<body>
    ...
    //  DATABASE RELATIONS USED: Patient, Schedule, Doctor 
    // Patient: Get logged-in patient info (pid, pname)
    // Schedule: Display available sessions with doctor details
    // Doctor: Join to show doctor information (docname, docemail)
            ...
            ?>
                ...
                <tr>
                   <td colspan="4">
                        ...
                        <table width="100%" class="sub-table scrolldown"  style="padding: 50px;border:none">
                            
                        <tbody>
                        
                            <?php

                                // schedule list rendering start
                                ...
                                // sessions grid rows end
                            }
                                // schedule list rendering end
    ...
    <!--  PATIENT DASHBOARD & FEATURES - SCHEDULE VIEWING SECTION END -->
