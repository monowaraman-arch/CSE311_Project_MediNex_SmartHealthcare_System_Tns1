...
<body>
 ...
 <div class="container">
     ...
     <table class="menu-container" >
        ...
        <!--  APPOINTMENT BOOKING HEADER SECTION START -->
        <div class="dash-body">
            <div class="container-fluid mt-3">
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col">
                        <form action="schedule.php" method="post" class="d-flex gap-2">
                            <input type="search" name="search" class="form-control" placeholder="Search Doctor name or Email or Date (YYYY-MM-DD)" list="doctors">
                            <?php
                            echo '<datalist id="doctors">';         /// searher for header section
                ...
                <!--  APPOINTMENT BOOKING HEADER SECTION END  -->

                <!--  APPOINTMENT BOOKING CONTENT SECTION START  -->
