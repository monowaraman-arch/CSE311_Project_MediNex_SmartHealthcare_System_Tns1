        ...
        <div class="dash-body">
            <div class="container-fluid mt-3">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <h4 class="mb-0">Schedule Manager</h4>
                    </div>
                    <div class="col-auto text-end">
                        <small class="text-muted d-block">Today's Date</small>
                        <strong><?php date_default_timezone_set('Asia/Dhaka'); $today = date('Y-m-d'); echo $today; $list110 = $database->query("select * from schedule;"); ?></strong>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <h5 class="mb-0">Schedule a Session</h5>
                    </div>
                    <div class="col-auto">
                        <a href="?action=add-session&id=none&error=0" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add a Session</a>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <h6>All Sessions (<?php echo $list110->num_rows; ?>)</h6>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                                    ...
                                    if($result->num_rows==0){
                                        ...
                                        for ($x=0; $x<$result->num_rows;$x++){
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="?action=view&id='.$scheduleid.'" class="btn btn-sm btn-outline-info" style="color: #0dcaf0 !important; border-color: #0dcaf0; background-image: none !important; background-repeat: no-repeat !important;">View</a>
                                                        <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="btn btn-sm btn-outline-danger" style="color: #dc3545 !important; border-color: #dc3545; background-image: none !important; background-repeat: no-repeat !important;">Remove</a>
                                                    </div>
                                                </td>
                                            </tr>';
                                        }
