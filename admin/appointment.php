        ...
        <div class="dash-body">
            <div class="container-fluid mt-3">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <h4 class="mb-0">Appointment Manager</h4>
                    </div>
                    <div class="col-auto text-end">
                        <small class="text-muted d-block">Today's Date</small>
                        <strong><?php date_default_timezone_set('Asia/Dhaka'); $today = date('Y-m-d'); echo $today; $list110 = $database->query("select * from appointment;"); ?></strong>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <h6>All Appointments (<?php echo $list110->num_rows; ?>)</h6>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                                    ...
                                    if($result->num_rows==0){
                                        ...
                                        for ($x=0; $x<$result->num_rows;$x++){
                                            ...
                                            echo '<tr>
                                                ...
                                                <td class="text-center fs-4 fw-bold">'.$apponum.'</td>
                                                <td>'.substr($docname,0,25).'</td>
                                                <td>'.substr($title,0,15).'</td>
                                                <td class="text-center small">'.substr($scheduledate,0,10).'<br>'.substr($scheduletime,0,5).'</td>
                                                <td class="text-center">'.$appodate.'</td>
                                                <td>
                                                    <a href="?action=drop&id='.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.'" class="btn btn-sm btn-outline-danger" style="color: #dc3545 !important; border-color: #dc3545; background-image: none !important; background-repeat: no-repeat !important;">Cancel</a>
                                                </td>
                                            </tr>';
                                        }
                                    }
